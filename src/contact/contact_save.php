<?php
    ...
    $message .= "<h1>".str_replace("aA","'",$description)."<br />invest amount: ".$investamount."&euro;"."<br />invest period:".$investperiod."<br />contact date :".$timestamp."</h1><br />".'<div style="border:none;border-radius:3px;color:white;padding:15px" bgcolor="#5865f2"><a href="https://rshcoin.com/contact-to.html?param=';  
